...
(function(api){
  ...
  api.signIn = function(param) {
    console.log('sign in :'+param);
  };
...
(function(api) {
  ...
  var ACCESS_TOKEN_STORAGE_KEY = 'veda-access-token';
  ...
  api.signIn  = function(sitekey, apikey, successCallback, errorCallback) {
    var sitekey = sitekey;
    var apikey = apikey;
